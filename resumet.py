...
connection = pymysql.connect(
    host="localhost", user="root", password="", db="resumet", port=3306
)
...
st.set_page_config(
    page_title="Resumet - Resume Analyser",
...
def run():
    st.title("Resumet - Resume Analyser")
    ...
    if choice == "User":
        st.markdown(
            """<h5 style='text-align: left; color: #77ddf2;padding:20px 0;'>* Upload your resume, and get smart recommendation based on it."</h5>""",
        ...
        if st.button("Login"):
            if ad_user == "jameel" and ad_password == "#resumeT234":
